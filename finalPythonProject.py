...
class Story:
    ...
    def makeStory(self):
        ...
        story2 = name + " was chilling at home in " + place  + ". There " + pronoun1 + " saw one animal in trouble, " + pronoun1 + " was too busy that " + pronoun1 + " did not help it, so " + pronoun1 + " walked away. Days passed by, but one day " + name + " got stuck in some serious problem, but there was no one to help " + pronoun2 + ", in such situation " + pronoun1 + " realized that even " + pronoun1 + " left that " + animal + " all alone in that situation. " + pronoun1 + " got to know how it is like to be left all alone."
        ...
        story4 = "There once a child named " + name + " lived in place. " + pronoun1 + " always used to joke on people of " + place + ". One day " + pronoun1 + " was in serious trouble but due to " + pronoun2 + " habbit of joking no one believed " + pronoun3 + ". So, " + pronoun1 + " was left all alone."
